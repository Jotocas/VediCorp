...
public class ConfigApi {
    //public static final String baseUrlE = "http://10.0.2.2:8073";
    public static final String baseUrlE = "http://192.168.1.7:8073";
    private static Retrofit retrofit;
    private static String token = "";

    private static UsuarioApi usuarioApi;
    private static ProductoApi productoApi;
    private static VentasResumenApi comprasResumenApi;
    ...
    public static VentasResumenApi getComprasResumenApi() {
        if (comprasResumenApi == null) {
            comprasResumenApi = retrofit.create(VentasResumenApi.class);
        }
        return comprasResumenApi;
    }
